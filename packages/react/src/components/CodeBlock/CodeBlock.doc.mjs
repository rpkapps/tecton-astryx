...
export const docs = {
  ...
  props: [
    ...
    },
    {
      ...
      description:
        'Per-instance syntax theme override. Shorthand for wrapping the block in <CodeTheme theme={...}>. Defaults to the nearest CodeTheme ancestor or the theme-level syntax colors.',
    },
    {
      name: 'highlightMode',
