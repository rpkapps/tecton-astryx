...
export function ToggleButtonGroupWithIcons() {
  const [value, setValue] = useState('grid');
  return (
    <ToggleButtonGroup value={value} onChange={setValue} label="View mode">
      <ToggleButtonGroupSegment value="grid" label="Grid" icon={<GridIcon />} />
      <ToggleButtonGroupSegment value="list" label="List" icon={<ListIcon />} />
