...
export const docs = {
  name: 'ScrollableArea',
  displayName: 'ScrollableArea',
  group: 'ScrollableArea',
  category: 'Layout',
  keywords: [
    'scroll',
    'overflow',
  ...
  props: [
    ...
    },
    {
      name: 'maxWidth',
      type: 'SizeValue',
      description: 'Maximum width of the viewport.',
    },
    {
      name: 'minHeight',
      type: 'SizeValue',
      description: 'Minimum height of the viewport.',
    },
    {
      name: 'stickyContainment',
      type: "'whenScrollable' | 'always'",
      description:
