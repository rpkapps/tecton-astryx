...
export const docs = {
  ...
  displayName: 'ChatDictationButton',
  group: 'ChatDictationButton',
  category: 'Chat',
  keywords: [
    'dictation',
    'microphone',
  ...
  examples: [
    ...
    'ChatDictationButtonDictationInComposer',
    'ChatDictationButtonDictationStates',
    'ChatDictationButtonShowcase',
    'ChatDictationButtonSizes',
  ],
  notes: [
