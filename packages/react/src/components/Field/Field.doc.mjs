...
export const docs = {
  ...
  usage: {
    description:
      'Field is a low-level wrapper for custom, native, or third-party controls that do not already provide field label, description, and status UI.',
    bestPractices: [
      {
        guidance: true,
        description:
      ...
      },
      {
        guidance: false,
        description:
          'Nest Field around styled inputs such as TextField, Autocomplete, Select, DateInput, or TextArea; those components already render their own Field shell.',
      },
      {
        guidance: false,
        description:
