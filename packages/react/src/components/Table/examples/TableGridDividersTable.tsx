...
const columns: TableColumn<Metric>[] = [
  {key: 'metric', header: 'Metric', width: {share: 2}},
  {key: 'q1', header: 'Q1', width: 90, align: 'end'},
  {key: 'q2', header: 'Q2', width: 90, align: 'end'},
  {key: 'q3', header: 'Q3', width: 90, align: 'end'},
  {key: 'q4', header: 'Q4', width: 90, align: 'end'},
];

export function TableGridDividersTable() {
  return (
    <Table
      data={metrics}
      columns={columns}
