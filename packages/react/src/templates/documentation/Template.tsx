          ...
          <VStack gap={10}>
            <Card padding={10}>
              <HStack gap={8}>
                <StackItem size="fill">
                  <VStack gap={4}>
                    <Text variant="display1">Web overview</Text>
                    <Text variant="large" weight="regular" color="secondary">
              ...
              <VStack key={category.label} gap={4}>
                ...
                <Grid columns={{minWidth: 260}} gap={2}>
                  {category.items.map(item => (
                    ...
                    >
                      <VStack gap={3}>
                        <Card variant="muted" padding={0} minHeight={160} />
                        <VStack gap={0.5}>
                          <Text variant="medium" weight="bold">
                            {item.name}
                          </Text>
                          <Text variant="medium" color="secondary" maxLines={3}>
                            {item.desc}
                          </Text>
                        </VStack>
                      </VStack>
