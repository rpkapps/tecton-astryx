...
export const docs = {
  ...
  title: 'Accessibility',
  description:
    'What Tecton guarantees, what it needs from you, and where a dark, dense interface takes particular care.',
  category: 'Guides',
  sections: [
    {
      ...
      content: [
        {
          ...
          items: [
            ...
            'Focus is always visible: a hot-pink 2px ring at a 2px offset, on every control in the system, in both colour modes.',
            'A group that behaves as one control — a radio group, a toggle-button group, a tab strip — is one tab stop, with arrow keys moving inside it.',
            'Overlays manage focus: a dialog traps it, returns it to the trigger on close, and closes on Escape.',
            'Icons are hidden from assistive technology unless you give them a label.',
          ],
        },
        {
          type: 'prose',
          text: 'Each component page states the specifics for that component under "Accessibility".',
        },
      ],
    },
    {
      title: 'What Tecton needs from you',
      content: [
        {
          type: 'table',
          ...
          rows: [
            ...
            [
              'Document structure',
              "Headings, landmarks and reading order are yours. `Heading`'s `outlineLevel` exists so the visual size never forces a wrong rank.",
            ],
            [
            ...
            [
              ...
              'Use `Alert`, `Progress` or `useToast` rather than colouring text: a colour change is invisible to a screen reader.',
            ],
          ],
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          type: 'list',
          items: [
            'Keep body copy at `text.primary` or `text.secondary`. `subtlest` and `disabled` are for states, not for prose.',
            'Never let colour be the only signal. A verdict word, a status chip or an icon must carry the meaning as well as the hue — which is why Tecton prints "High" next to a red meter rather than colouring the meter alone.',
          ],
        },
        {
          type: 'prose',
      ...
      content: [
        {
          type: 'list',
          items: [
            'Dense is a choice, not a default: `sm` densities exist for tables and controls that genuinely need them, and a whole screen at `sm` is harder for everyone.',
            'Tecton animations are short and functional, and they are drawn from the duration tokens rather than invented per component. Respect `prefers-reduced-motion` in anything you animate yourself.',
      ...
      content: [
        {
          ...
          items: [
            ...
            'Zoom to 200%. Panels should reflow rather than clip.',
          ],
        },
      ],
    },
