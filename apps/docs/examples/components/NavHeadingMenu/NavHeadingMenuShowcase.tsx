...
import {SideNav, SideNavHeading} from '@tecton/react/SideNav';
import {NavHeadingMenu, NavHeadingMenuItem} from '@tecton/react/NavMenu';
...
export function NavHeadingMenuShowcase() {
  return (
