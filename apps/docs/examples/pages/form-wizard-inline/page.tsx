...
import {Layout, LayoutContent, LayoutHeader} from '@tecton/react/Layout';
                            ...
                            <Card variant="muted" padding={4}>
                              ...
                              <MetadataList orientation="vertical">
                                ...
                                <MetadataListItem
                                  label="Triggers"
                                  icon={
                                    <Icon icon={ElectricityIcon} size="sm" />
                                  }
                                >
                                  {triggerSummary}
                                </MetadataListItem>
                                <MetadataListItem
                                  label="Runner"
                                  icon={<Icon icon={NodeIcon} size="sm" />}
                                >
                                  {`${runner.label}, ${runner.memoryGB} GB · Node ${nodeVersion}`}
                                </MetadataListItem>
                                <MetadataListItem
                                  label="Toolchain"
                                  icon={<Icon icon={DiscoveryIcon} size="sm" />}
                                >
