...
import {Dialog} from '@tecton/react/Dialog';
...
import type {TableColumn} from '@tecton/react/Table';
...
const BLOCK_META: Record<BlockType, {label: string; icon: IconComponent}> = {
  hero: {label: 'Hero', icon: ViewModuleIcon},
  text: {label: 'Text', icon: ReportsAnalyticsIcon},
  image: {label: 'Image', icon: ImageIcon},
  button: {label: 'Button', icon: SelectCursorIcon},
  cards: {label: 'Cards', icon: ViewColumnIcon},
  features: {label: 'Features', icon: Robot2Icon},
  cta: {label: 'CTA', icon: NotificationsIcon},
};
...
const CATEGORY_ICONS: Record<string, IconComponent> = {
  'Food & Drink': MoneyIcon,
  Groceries: MoneyIcon,
  Income: MoneyIcon,
  Transport: AnnotateIcon,
...
const TRANSACTION_COLUMNS: TableColumn<Transaction>[] = [
  {
    ...
    renderCell: (item: Transaction) => (
      <HStack gap={3} vAlign="center">
        <Icon icon={CATEGORY_ICONS[item.category] || Robot2Icon} />
        <VStack gap={0}>
  ...
  },
  {
    ...
    renderCell: () => (
      <Button
        label="More"
        icon={<Icon icon={MoreVertIcon} size="sm" />}
        variant="ghost"
        size="sm"
        isIconOnly
      />
              ...
              <Toolbar
                ...
                startContent={
                  ...
                  >
                    <SegmentedControlItem
                      value="desktop"
                      label="Desktop"
                      icon={<Icon icon={WindowIcon} size="sm" />}
                      isLabelHidden
                    />
                    <SegmentedControlItem
                      value="tablet"
                ...
                endContent={
                  <HStack gap={2}>
                    <Button
                      label="Preview"
                      icon={<Icon icon={VisibilityIcon} size="sm" />}
                      variant="ghost"
                      isIconOnly
                    />
                    <Button label="Publish" variant="primary" />
