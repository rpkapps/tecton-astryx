...
import type {SearchSource, SearchableItem} from '@tecton/react/Typeahead';
import {VisuallyHidden} from '@tecton/react/VisuallyHidden';
import {useContainerReveal, useMediaQuery} from '@tecton/react/hooks';
import type {UseContainerRevealReturn} from '@tecton/react/hooks';
import {
  Table,
  pixel,
  proportional,
...
const ROW_ACTIONS: RowAction[] = [
  ...
  {id: 'move', label: 'Move to folder', icon: ExportUploadIcon},
  {id: 'delete', label: 'Delete', icon: DeleteIcon},
  {id: 'reply', label: 'Reply', icon: UndoIcon},
];
  ...
  return (
    <VStack gap={2}>
      <HStack gap={1} vAlign="center">
        <Icon icon={LinkIcon} size="sm" color="gray" />
...
const COMPOSER_TOOLS: {
  ...
  {id: 'attach', label: 'Attach files', icon: LinkIcon},
  {id: 'link', label: 'Insert link', icon: LinkIcon},
  {id: 'image', label: 'Insert image', icon: ImageIcon},
  {id: 'emoji', label: 'Insert emoji', icon: PersonIcon},
];
