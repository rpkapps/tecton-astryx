...
import {Collapsible} from '@tecton/react/Collapsible';
...
import {HStack, Stack, StackItem, VStack} from '@tecton/react/Stack';
...
const STEPS = [
  {label: 'Cart', icon: MoneyIcon},
  {label: 'Shipping', icon: MapIcon},
  {label: 'Delivery', icon: OilRigOffshoreIcon},
  {label: 'Payment', icon: MoneyIcon},
];
  ...
  const summaryBody = (
    <VStack gap={4}>
      ...
      {subtotal - discount < FREE_SHIPPING_THRESHOLD && (
        <Banner
          status="info"
          icon={<Icon icon={OilRigOffshoreIcon} size="sm" />}
