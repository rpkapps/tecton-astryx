...
import {HStack, StackItem, VStack} from '@tecton/react/Stack';
import {StatusDot} from '@tecton/react/StatusDot';
import {Step, Stepper} from '@tecton/react/Stepper';
    ...
    STEPS.map((s, i) => {
      ...
      return (
        <Step
          ...
          indicator={
            hasError ? <Icon icon={WarningIcon} size="sm" /> : 'number'
          }
        />
      );
    });
              ...
              {step === 4 && (
                <VStack gap={5}>
                  ...
                  <MetadataList columns="multi">
                    ...
                    <MetadataListItem
                      label="Language"
                      icon={<Icon icon={AppsIcon} size="sm" />}
                    >
                    ...
                    <MetadataListItem
                      label="Categories"
                      icon={<Icon icon={NumericIcon} size="sm" />}
                    >
                      {categories.length === 0
                        ? '—'
                    ...
                    <MetadataListItem
                      label="Availability"
                      icon={<Icon icon={MapIcon} size="sm" />}
                    >
                      {scope === 'worldwide'
                        ? 'Worldwide'
                        : scope === 'exclusive'
                    ...
                    <MetadataListItem
                      ...
                      icon={<Icon icon={FacilityIcon} size="sm" />}
                    >
