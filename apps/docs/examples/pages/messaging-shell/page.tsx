...
const RAIL_ITEMS = [
  ...
  {id: 'dms', label: 'Direct messages', icon: AnnotateIcon},
  {id: 'activity', label: 'Activity', icon: NotificationsIcon},
  {id: 'saved', label: 'Saved items', icon: AddPinIcon},
];
    ...
    <Stack direction="vertical" style={styles.sidebar}>
      <HStack gap={2} style={styles.sidebarHeader}>
        ...
        <IconButton
          label="New message"
          tooltip="New message"
          icon={<Icon icon={EditSquareIcon} size="sm" color="inherit" />}
          variant="ghost"
          size="sm"
          onClick={() => {}}
        />
        ...
        >
          {visibleChannels.map(channel => (
            <ListItem
              ...
              startContent={
                <Icon icon={NumericIcon} size="sm" color="secondary" />
              }
              endContent={
                channel.unread > 0 ? (
    ...
    <Stack direction="vertical" style={styles.threadColumn}>
      <HStack gap={2} style={styles.threadHeader}>
        ...
        <IconButton
          ...
          icon={<Icon icon={CloseIcon} size="sm" color="inherit" />}
          variant="ghost"
          size="sm"
