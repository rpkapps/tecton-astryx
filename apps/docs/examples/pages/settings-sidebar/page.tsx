...
const NAV_ITEMS = [
  ...
  {label: 'Taxes', icon: ReportsAnalyticsIcon},
  {label: 'Payments', icon: MoneyIcon},
  {label: 'Languages & currency', icon: MapIcon},
  {label: 'Travel for work', icon: ProjectIcon},
];
    ...
    <VStack gap={4} style={sideNavPadding}>
      ...
      <List density="spacious">
        <ListItem
          ...
          startContent={<Icon icon={EngineeringIcon} />}
          onClick={() => {}}
        />
      </List>
    </VStack>
