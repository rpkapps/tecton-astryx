            ...
            <VStack gap={0}>
              ...
              <VStack gap={0}>
                ...
                <HStack gap={1} vAlign="center" wrap="wrap">
                  ...
                  <HStack gap={1} vAlign="center">
                    <Bullet />
                    <Icon icon={AddPinIcon} size="sm" color="secondary" />
                    <Text type="body" maxLines={1}>
                      Needs attention
                    </Text>
                  </HStack>
                ...
                <StackItem size="fill">
                  <VStack gap={2}>
                    ...
                    <HStack gap={3} vAlign="center">
                      <HStack gap={1} vAlign="center">
                        <Icon
                          icon={CheckCircleOpenIcon}
                          size="xsm"
                          color="secondary"
                        />
                        <Icon icon={CrownIcon} size="xsm" color="secondary" />
                        <Text type="supporting" color="secondary">
                          {item.reactions}
                        </Text>
                      </HStack>
  ...
  return (
    <>
      ...
      {/* Mobile: the side panel content opens as a full-screen dialog. (A
          side drawer/sheet would be more idiomatic, but Tecton has no Drawer
