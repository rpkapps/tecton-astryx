...
import {HStack, VStack, StackItem} from '@tecton/react/Stack';
import {Layout, LayoutContent, LayoutPanel} from '@tecton/react/Layout';
...
import {Table, pixel} from '@tecton/react/Table';
import {Icon} from '@tecton/react/Icon';
import {Section} from '@tecton/react/Section';
import {Center} from '@tecton/react/Center';
import {Outline, type OutlineItem} from '@tecton/react/Outline';
import {AddIcon, ExpandContentIcon, OpenInNewIcon} from '@tecton/react/icons';
                      ...
                      <HStack gap={3} vAlign="center">
                        ...
                        <HStack gap={1} vAlign="center">
                          ...
                          <IconButton
                            ...
                            variant="ghost"
                            size="sm"
                            icon={<Icon icon={ExpandContentIcon} />}
                          />
                        </HStack>
                      </HStack>
                    </Section>
