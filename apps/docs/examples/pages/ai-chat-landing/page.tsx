...
import {Layout, LayoutContent, VStack, HStack} from '@tecton/react/Layout';
          ...
          <VStack gap={8} vAlign="center" style={pageStyle}>
            ...
            <VStack gap={1}>
              <HStack gap={2} vAlign="center">
                <Icon icon={Robot2Icon} size="md" color="accent" />
