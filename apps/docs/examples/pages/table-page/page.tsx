...
import {usePowerSearchConfig} from '@tecton/react/PowerSearch';
...
import {ExportUploadIcon, SearchIcon} from '@tecton/react/icons';
            ...
            <VStack gap={6} paddingBlockEnd={4}>
              <HStack gap={3} vAlign="center" wrap="wrap">
                ...
                <Button
                  label="Download PDF"
                  variant="secondary"
                  icon={<Icon icon={ExportUploadIcon} size="sm" />}
                />
              </HStack>
              <MetadataList
                columns="multi"
