...
import {HStack} from '@tecton/react/HStack';
...
import {ListItem} from '@tecton/react/List';
import {
  SegmentedControl,
...
import {Stack, StackItem} from '@tecton/react/Stack';
...
import {VStack} from '@tecton/react/VStack';
import {
  AnnotateIcon,
  AppsIcon,
  ChevronRightIcon,
...
const THEME_CHOICES: {
  ...
  {value: 'light', label: 'Light', scheme: 'light', icon: VisibilityIcon},
  {value: 'dark', label: 'Dark', scheme: 'dark', icon: VisibilityOffIcon},
  {
    value: 'system',
    label: 'System',
    scheme: 'system',
